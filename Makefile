...
SFML_file:
	clang++ Event.cpp Engine.cpp Engine_OpenGL.cpp App.cpp -std=c++17 -arch x86_64 -F/Library/Frameworks -framework SFML -lsfml-graphics -lsfml-audio -lsfml-window -lsfml-system -o SFML_file main.cpp && ./SFML_file
