...
Engine::Palette::Palette(const Point &start, double width, double height)
...
Engine::Palette_functor::Palette_functor(int color_window_id, Palette* palette) : window_id(color_window_id), palette(palette) {}

void Engine::Palette_functor::operator()(Engine::Button<Palette_functor>* button)
{
